...
VIPSystem.Conf.Card[8031]			= {Lv = 1, Time = (1*60*60*24)}--1 день	
VIPSystem.Conf.Card[7958]			= {Lv = 1, Time = (1*60*60*24)}--10 день	
VIPSystem.Conf.Card[7959]			= {Lv = 1, Time = (7*60*60*24)}--30 дней
VIPSystem.Conf.Card[7960]			= {Lv = 1, Time = (30*60*60*24)}--60 дней														--Lv1 VIP Card, 30 day(s) duration (seconds).
VIPSystem.Conf.Card[7961]			= {Lv = 2, Time = (1*60*60*24)}														--Lv2 VIP Card, 30 day(s) duration (seconds).
VIPSystem.Conf.Card[7962]			= {Lv = 2, Time = (7*60*60*24)}														--Lv2 VIP Card, 30 day(s) duration (seconds).
...
VIPSystem.Conf.Card[7965]			= {Lv = 3, Time = (7*60*60*24)}														--Lv3 VIP Card, 30 day(s) duration (seconds).
VIPSystem.Conf.Card[7966]			= {Lv = 3, Time = (30*60*60*24)}														--Lv3 VIP Card, 30 day(s) duration (seconds).


VIPSystem.Conf.Bonus[1]				= {STR = 25, AGI = 25, ACC = 25, CON = 25, SPR = 25, DEF = 100, PR = 1, MSPD = 50}	-- Attribute bonuses for Lv1 VIP.
VIPSystem.Conf.Bonus[2]				= {STR = 50, AGI = 50, ACC = 50, CON = 50, SPR = 50, DEF = 150, PR = 2, MSPD = 100}	-- Attribute bonuses for Lv2 VIP.
VIPSystem.Conf.Bonus[3]				= {STR = 100, AGI = 100, ACC = 100, CON = 100, SPR = 100, DEF = 200, PR = 3, MSPD = 100}	-- Attribute bonuses for Lv2 VIP.

-- Rewards for VIP Lv1.
VIPSystem.Conf.Rewards[1].Gold		= 10																				-- Amount gold that player will receive when using Lv1 VIP Card.
VIPSystem.Conf.Rewards[1].Items[1]	= {ID = 885, Quantity = 3, Quality = 103}											-- Items that player will receive when using Lv1 VIP Card.

-- Rewards for VIP Lv2.
VIPSystem.Conf.Rewards[2].Gold		= 20000000																				-- Amount gold that player will receive when using Lv2 VIP Card.
VIPSystem.Conf.Rewards[2].Items[1]	= {ID = 885, Quantity = 6, Quality = 104}											-- Items that player will receive when using Lv2 VIP Card.

-- Rewards for VIP Lv3.
VIPSystem.Conf.Rewards[3].Gold		= 30000000																				-- Amount gold that player will receive when using Lv3 VIP Card.
VIPSystem.Conf.Rewards[3].Items[1]	= {ID = 885, Quantity = 10, Quality = 106}											-- Items that player will receive when using Lv3 VIP Card.
