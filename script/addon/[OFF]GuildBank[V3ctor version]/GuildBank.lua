...
function ShowBank(role, bank)
	...
	if (n > 0) then 
		...
		for i = 1, n, 1 do
			HelpInfo(role,0, "[" .. items[i].pos .. "] " .. items[i].name .. " x " .. items[i].number)
		end
	else
		-- В банке пусто ...
		HelpInfo(role,0, "\194 \225\224\237\234\229 \194\224\248\229\233 \227\232\235\252\228\232\232 \239\243\241\242\238...")
