...
if m==1 then --如果此服务器上地图存在
    ...
    LG("init", "haidaohaijun_side release monster ended!")
end
...
if m==1 then --如果此服务器上地图存在
    ...
    LG("init", "haidaohaijun_side2 release monster ended!")
end
...
if m==1 then --如果此服务器上地图存在
    ...
    LG("init", "yeguai_guildwar release monster ended!")
end
...
if m==1 then --如果此服务器上地图存在
    ...
    LG("init", "yeguai_guildwar2 release monster ended!")
end
