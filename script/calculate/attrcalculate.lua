...
--Attributes Growth Rate of Champion Class
		Mxhp_con_rad1[JOB_TYPE_JUJS], Mxhp_con_rad2[JOB_TYPE_JUJS], Mxhp_lv_rad[JOB_TYPE_JUJS]	= 5, 10, 40 							--最大hp的属性影响系数：体质系数、等级系数、基本数
		Mxsp_sta_rad1[JOB_TYPE_JUJS], Mxsp_sta_rad2[JOB_TYPE_JUJS], Mxsp_lv_rad[JOB_TYPE_JUJS]	= 1, 0, 3 							--最大sp的属性影响系数：精力系数、体质系数、等级系数
		Mnatk_str_rad1[JOB_TYPE_JUJS], Mnatk_str_rad2[JOB_TYPE_JUJS], Mnatk_dex_rad1[JOB_TYPE_JUJS], Mnatk_dex_rad2[JOB_TYPE_JUJS]	= 2.1, 0.48, 0, 0		--最小攻击力的属性影响系数：力量系数
		Mxatk_str_rad1[JOB_TYPE_JUJS], Mxatk_str_rad2[JOB_TYPE_JUJS], Mxatk_dex_rad1[JOB_TYPE_JUJS], Mxatk_dex_rad2[JOB_TYPE_JUJS]	= 2.2, 0.49, 0, 0		--最大攻击的属性影响系数：力量系数
		Def_con_rad1[JOB_TYPE_JUJS], Def_con_rad2[JOB_TYPE_JUJS]	= 0.2, 0.13 										--防御的属性影响系数：专注系数
		Hit_dex_rad1[JOB_TYPE_JUJS], Hit_dex_rad2[JOB_TYPE_JUJS]	= 0.7, 0.5 										--命中的属性影响系数：专注系数、等级系数、最小命中率
		Flee_agi_rad1[JOB_TYPE_JUJS], Flee_agi_rad2[JOB_TYPE_JUJS]	= 0.65, 0.2										--闪避的属性影响系数：敏捷系数、等级系数、最小闪避率
		...
		Aspd_agi_rad[JOB_TYPE_JUJS]	= 1.8    												 		--攻击频率的属性影响系数：基础攻击、敏捷系数、最小攻击频率			
...
--Attributes Growth Rate of Crusader Class
		Mxhp_con_rad1[JOB_TYPE_SHUANGJS], Mxhp_con_rad2[JOB_TYPE_SHUANGJS], Mxhp_lv_rad[JOB_TYPE_SHUANGJS]	= 5, 8, 28 							--最大hp的属性影响系数：体质系数、等级系数、基本数
		...
		Mnatk_str_rad1[JOB_TYPE_SHUANGJS], Mnatk_str_rad2[JOB_TYPE_SHUANGJS], Mnatk_dex_rad1[JOB_TYPE_SHUANGJS], Mnatk_dex_rad2[JOB_TYPE_SHUANGJS]	= 1.73, 0.45, 0, 0	--最小攻击力的属性影响系数：力量系数
		Mxatk_str_rad1[JOB_TYPE_SHUANGJS], Mxatk_str_rad2[JOB_TYPE_SHUANGJS], Mxatk_dex_rad1[JOB_TYPE_SHUANGJS], Mxatk_dex_rad2[JOB_TYPE_SHUANGJS]	= 1.73, 0.45, 0, 0	--最大攻击的属性影响系数：力量系数
		Def_con_rad1[JOB_TYPE_SHUANGJS], Def_con_rad2[JOB_TYPE_SHUANGJS]	= 0.2, 0.1 											--防御的属性影响系数：专注系数
		Hit_dex_rad1[JOB_TYPE_SHUANGJS], Hit_dex_rad2[JOB_TYPE_SHUANGJS]	= 0.77, 0 											--命中的属性影响系数：专注系数、等级系数、最小命中率
		Flee_agi_rad1[JOB_TYPE_SHUANGJS], Flee_agi_rad2[JOB_TYPE_SHUANGJS]	= 0.73, 0											--闪避的属性影响系数：敏捷系数、等级系数、最小闪避率
		...
		Aspd_agi_rad[JOB_TYPE_SHUANGJS]	= 1.3    												 				--攻击频率的属性影响系数：基础攻击、敏捷系数、最小攻击频率			
...
--Attributes Growth Rate of Sharpshooter Class
		Mxhp_con_rad1[JOB_TYPE_JUJISHOU], Mxhp_con_rad2[JOB_TYPE_JUJISHOU], Mxhp_lv_rad[JOB_TYPE_JUJISHOU]	= 5, 10, 30 						--最大hp的属性影响系数：体质系数、等级系数、基本数
		...
		Mnatk_str_rad1[JOB_TYPE_JUJISHOU], Mnatk_str_rad2[JOB_TYPE_JUJISHOU], Mnatk_dex_rad1[JOB_TYPE_JUJISHOU], Mnatk_dex_rad2[JOB_TYPE_JUJISHOU]	= 0,0,2, 0.47	--最小攻击力的属性影响系数：力量系数
		Mxatk_str_rad1[JOB_TYPE_JUJISHOU], Mxatk_str_rad2[JOB_TYPE_JUJISHOU], Mxatk_dex_rad1[JOB_TYPE_JUJISHOU], Mxatk_dex_rad2[JOB_TYPE_JUJISHOU]	= 0,0,2, 0.48	--最大攻击的属性影响系数：力量系数
		Def_con_rad1[JOB_TYPE_JUJISHOU], Def_con_rad2[JOB_TYPE_JUJISHOU]	= 0.08, 0.11										--防御的属性影响系数：专注系数
		Hit_dex_rad1[JOB_TYPE_JUJISHOU], Hit_dex_rad2[JOB_TYPE_JUJISHOU]	= 0.7, 0 										--命中的属性影响系数：专注系数、等级系数、最小命中率
		Flee_agi_rad1[JOB_TYPE_JUJISHOU], Flee_agi_rad2[JOB_TYPE_JUJISHOU]	= 0.65, 0										--闪避的属性影响系数：敏捷系数、等级系数、最小闪避率
		...
		Aspd_agi_rad[JOB_TYPE_JUJISHOU]	= 1.8												 			--攻击频率的属性影响系数：基础攻击、敏捷系数、最小攻击频率			
...
--Attributes Growth Rate of Cleric Class
		Mxhp_con_rad1[JOB_TYPE_SHENGZHIZHE], Mxhp_con_rad2[JOB_TYPE_SHENGZHIZHE], Mxhp_lv_rad[JOB_TYPE_SHENGZHIZHE]	= 7, 7, 30							--最大hp的属性影响系数：体质系数、等级系数、基本数
		Mxsp_sta_rad1[JOB_TYPE_SHENGZHIZHE], Mxsp_sta_rad2[JOB_TYPE_SHENGZHIZHE], Mxsp_lv_rad[JOB_TYPE_SHENGZHIZHE]	= 3, 1.8, 7							--最大sp的属性影响系数：精力系数、体质系数、等级系数
		...
		Def_con_rad1[JOB_TYPE_SHENGZHIZHE], Def_con_rad2[JOB_TYPE_SHENGZHIZHE]		= 0.2,	0.1 											--防御的属性影响系数：专注系数
...
--Attributes Growth Rate of Seal Master Class
		Mxhp_con_rad1[JOB_TYPE_FENGYINSHI], Mxhp_con_rad2[JOB_TYPE_FENGYINSHI], Mxhp_lv_rad[JOB_TYPE_FENGYINSHI]	= 20, 19, 65							--最大hp的属性影响系数：体质系数、等级系数、基本数
		...
		Def_con_rad1[JOB_TYPE_FENGYINSHI], Def_con_rad2[JOB_TYPE_FENGYINSHI]	= 0.12, 0.12 												--防御的属性影响系数：专注系数
...
--Attributes Growth Rate of Voyager Class
		Mxhp_con_rad1[JOB_TYPE_HANGHAISHI], Mxhp_con_rad2[JOB_TYPE_HANGHAISHI], Mxhp_lv_rad[JOB_TYPE_HANGHAISHI]	= 7, 7, 34						--最大hp的属性影响系数：体质系数、等级系数、基本数
		...
		Def_con_rad1[JOB_TYPE_HANGHAISHI], Def_con_rad2[JOB_TYPE_HANGHAISHI]	= 0.3, 0.14 											--防御的属性影响系数：专注系数
...
function ExAttrCheck(role)  						--[[基本扩展属性计算]]--
	...
	local aspd = math.floor ( 100000/ (math.min ( math.floor( 65 +  Agi(role) * Aspd_agi_rad[job] ) , 700 ) ) )											--[[计算基本aspd]]--
...
--	SetCharaAttr(lv, ship_role, ATTR_LV )											--[[赋值船只lv]]--
	...
	SetCharaAttr(ship_aspd_final, ship_role, ATTR_
