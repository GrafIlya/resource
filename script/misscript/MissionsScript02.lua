...
--									                                    --
--									                                    --
--     MissionScript02.lua Переведен командой Little WarriorS Team.        --
--									                                    --
--									                                    --
--------------------------------------------------------------------------
...
----------------------------КЧПЇГШКйµДїЪРЕ
	...
	MisBeginTalk( "<t>196обрый день. Я думаю что тебе пора отнести письмо секретарю Аргента, <bСальвьеру>. Удачи и не опаздывай!" )
	MisBeginCondition(NoRecord, 200)
	MisBeginCondition(NoMission, 200)
	MisBeginCondition(NoMission, 201)
	MisBeginCondition(NoMission, 202)
...
-------------------------------------------------И«МеКіОпЦР¶ѕ
	...
	MisBeginTalk( "<t>Кхе-кхе.Извени похоже еда была отравлена.Отнеси пожалуйста <yLunch Sample> врачу в аргенте <bPhysician Ditto> и попроси разобраться!" )
...
-------------------------------------------------ЅвТ©Ф­БП
	...
	MisHelpTalk("<t>Мне надо 3 <yCashmere>, 3 <yPiglet Tail> и 3 <yHard Shell>. Ты разыскал все?")
...
-----------------------------------іВДкѕЙКВ
	...
	MisResultAction(SystemNotice, "Получить еФрукте" )
...
-----------------------------------Г°ПХѕ«Йс
	...
	MisResultTalk("<t>IО-о-о я не видела вас очень долгое время!Вы пришли что бы доказать своюсилу духа?!")
...
-----------------------------------ГьФЛЦ®ВЦ
	...
	MisBeginTalk( "<t>Я не крал противоядия. .. подождите, подождите! Вы действительно собираетесь оставить меня?  Я украл формулу у <bОператора Буниi> из <bБухты Айрис> по координатам  (2042, 635). ")
...
------------------------------------------------------------------Д§Б¦№ЗН··Ы
	...
	MisCancelAction(SystemNotice, "Квест не может быть удален")
	 ...
	 MisNeed(MIS_NEED_DESP, "Найдите Волшебная кость е 3шт ")
...
--------------------------------------------------------------------------Little WarriorS Project 2010-2011-------------------------------------------------------------------------
