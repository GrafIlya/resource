...
function r_talk01 ()
	...
	Talk( 9,  "Гид по серверу: Ну если ты новичёк, то тебе лучше идти в лут-зону, попасть в неё можно через портальщика Хоть куда. Находится он на левом выходе аргента. Тебя телепортирует в шахты, там тебежелательно пройти на второй уровень, потому что там нет пвп зоны в отличии от первого уровня шахт. Там с мобов ты будешь выбивать пачкули которые сможешь обменять у Мистера-Келя на сами собственно кели. Если ты уже сильный игрок, то можешь фармить кели в подземном мире, открывается он каждые три часа по МСК, начиная с 00:00 " )
...
----------------------------------------------------------
function vra4 ()
Talk( 1, "Здравствуйте,вы что что то хотели?! " )
Text( 1, " Да, хотел бы руны Кэль обменять на еду ", JumpPage, 2)

Talk( 2, " Хорошо! " )
Text( 2, " 20 рун Кэль на 20 Весногр.свит и 20 Креветочной пышки ", JumpPage, 3)


Talk(3," Давайте 20 Кэль! " )
InitTrigger()
...
function r_talk235()
		...
		Talk( 1, " Ангел: Привет! Ты знаешь зачем пришёл?. ")
	Text( 1, " Нет, расскажи мне  ", JumpPage, 2)
	Text( 1, " Я хочу переродиться во второй раз ", JumpPage, 6)
	
	
	Talk( 2, " Ну, что ты хочешь знать? ")
	Text( 2, " Классы после реберна ", JumpPage, 3)
	Text( 2, " Условия реберна ", JumpPage, 4)
	Text( 2, " Как получить 2 камень реберна ", JumpPage, 5)
	
	Talk( 3, " Реберн позволяет поменять класс: Круз = Вой, Шарп = Круз и т.д. Еще он позволяет скинуть все статы и скиллы, это хорошо для поротых персов. ")
	Text( 3, " Спасибо ", CloseTalk)
	Text( 3, " Спасибо, я хочу получить реберн ", JumpPage, 6)

	Talk( 4, " Условия реберна: тебе нужен камень перерождения, потом ты должен все снять с себя, и подойти ко мне и нажать 'Я хочу ребернутся' ")
	Text( 4, " Спасибо ", CloseTalk)
	Text( 4, " Спасибо, я хочу получить реберн ", JumpPage, 6)

	Talk( 5, " Камень можно получить квестом, выйграть ивент. ")
	Text( 5, " Спасибо ", CloseTalk)
	Text( 5, " Спасибо, я хочу получить реберн ", JumpPage, 6)

	Talk( 6, " Приготовься! У тебя всё при себе? " )
	Text( 6, " Правила ", JumpPage, 2)
	Text( 6, " Я хочу стать Воителем ",  GetChaName1_born2, 1)
	Text( 6, " Я хочу стать Чемпионом ",  GetChaName2_born2, 1)
	Text( 6, " Я хочу стать Клериком ",  GetChaName5_born2, 1)
	Text( 6, " Я хочу стать Вояджером ",  GetChaName3_born2, 1)
	Text( 6, " Я хочу стать Стрелком ", GetChaName4_born2, 1)   
	Text( 6, " Я хочу стать Ведьмой ", GetChaName6_born2, 1)
	Text( 6, " Я морально не готов ", CloseTalk)
...
function kk_talk01 ()
	...
	Talk( 1,  "Администратор Хаоса: В бою выживают лишь сильнейшие, и лишь сильнейшие получают уважение...Время работы Хаоса Аргента Каждые 2 часа : 00 00,02 00,04 00....	" )
	Text( 1,  "Получить Медаль отваги ", JumpPage, 2)
	...
	AddNpcMission 	(324322)
		AddNpcMission 	(3243222)
...
function r_HeSToP31()
	...
	Text(1, " Мини шайтан ", GoTo, 232, 207, "07xmas2") 
	Text(1, " Мини ледынь ", GoTo, 227, 59, "07xmas2")
	Text(1, " Мини гром ", GoTo, 47, 53, "07xmas2") 
...
function r_HeSToP32()
	...
	Talk(1, "Привет! Выбери место, куда ты хочешь отправиться:")
	Text(1, " Мини шайтан ", GoTo, 232, 207, "07xmas2") 
	Text(1, " Мини аргент ", GoTo, 40, 217, "07xmas2")
	Text(1, " Мини гром ", GoTo, 47, 53, "07xmas2") 
	Text(1, " Уйти ", CloseTalk)
...
function r_HeSToP35()
	...
	Talk(1, "Привет! Выбери место, куда ты хочешь отправиться:")
	Text(1, " Кач зона (+ боссы в аргенте) ", GoTo, 2165, 2781, "garner")
	Text(1, " Уйти ", CloseTalk)
...
function r_HeSToP36()
	...
	Talk(1, "Привет! Выбери место, куда ты хочешь отправиться ") 
	Text(1, " В аргент ", GoTo, 2194, 2779, "garner")
	Text(1, " Уйти ", CloseTalk)
...
function r_HeSToP37()
	...
	Talk(1, "Привет! Выбери место, куда ты хочешь отправиться:") 
	Text(1, " Остров зефира ", GoTo, 3260, 3280, "garner")
	Text(1, " Ледниковый остров ", GoTo, 2273, 1122, "garner")
	Text(1, " остров Отверженных ", GoTo, 3590, 725, "garner")
	Text(1, " Уйти ", CloseTalk)
