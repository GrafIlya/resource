...
function r_talk151 ()
	...
	Talk( 1, "Ñèíäáàä: Ïðèâåò! ß îòâå÷àþ çäåñü çà ïîòðîéêó êîðàáëåé! ")
	InitTrigger()
	TriggerCondition( 1, IsBoatFull )
	TriggerAction( 1, SystemNotice, "Äîñòèãíóòî ìàêñèìàëüíîå êîëè÷åñòâî êîðàáëåé. Íåëüçÿ áîëüøå ïîñòðîèòü êîðàáëü. ")
	TriggerFailure( 1, JumpPage, 2 )
	Text( 1, "Ïîñòðîèòü êîðàáëü ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, HasBoatInBerth, 1 )
	TriggerAction( 1, BoatLevelBerthList, 1 )
	TriggerFailure( 1, JumpPage, 3 )
	Text( 1, "Óëó÷øèòü êîðàáëü ", MultiTrigger, GetMultiTrigger(), 1 )
	
	Talk( 2, "Ñèíäáàä: êàêîé êîðàáëü æåëàåòå ïîñòðîèòü? ")
	InitTrigger()
	TriggerCondition( 1, BoatBuildCheck, 1 )
	TriggerAction( 1, CreateBoat, 1, 1 )
	Text( 2, "Ïîñòðîèòü Ãóïïè ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, BoatBuildCheck, 2 )
	TriggerAction( 1, CreateBoat, 2, 1 )
	Text( 2, "Ïîñòðîèòü Òðàíñïîðòåð ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, BoatBuildCheck, 3 )
	TriggerAction( 1, CreateBoat, 3, 1 )
	Text( 2, "Ïîñòðîèòü Ëåòó÷óþ ðûáó ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, BoatBuildCheck, 6 )
	TriggerAction( 1, CreateBoat, 6, 1 )
	Text( 2, "Ïîñòðîèòü Ðûáó-ìå÷ ", MultiTrigger, GetMultiTrigger(), 1 )

	Talk( 3, "Ñèíäáàä: ×òîáû óëó÷øèòü ñóäíî âû äîëæíû ïîñòàâèòü åãî â ýòó ãàâàíü. Êðîìå òîãî ó âàñ äîëæíî áûòü íåîáõîäèìîå êîëè÷åñòâî îïûòà êîðàáëÿ. Îïûò ìîæíî çàðàáîòàòü óáèâàÿ ìîðñêèõ ìîíñòðîâ. ")
end
------------------------------------------------------------
-- °×Òø³Ç-----º£¸ÛÖ¸»Ó¡¤Ñ©Àò
------------------------------------------------------------
...
function r_talk152()
	...
	Text( 1, "Ïî÷èíêà ", MultiTrigger, GetMultiTrigger(), 2 ) 
	InitTrigger()
	TriggerCondition( 1, HasLuanchOut )
	...
	Text( 1, "Âîñòàíîâëåíèå êîðàáëÿ ", MultiTrigger, GetMultiTrigger(), 1 ) 

	Talk( 3, "Èçâèíè, íî ó òåáÿ íåòó êîðàáëÿ, êàê êóïèøü, òîãäà è ïðèõîäè!" )
	Talk( 4, "Èçâèíè, íî ó òåáÿ íåõâàòàåò äåíåã íà ïî÷èíêó êîðàáëÿ " )
	Talk( 5, "Èçâèíè, íî ó òåáÿ íåõâàòàåò äåíåã íà çàïðàâêó êîðàáëÿ " )
	Talk( 6, "Èçâèíè, íî ó òåáÿ íåõâàòàåò äåíåã íà âîñòàíîâëåíèå êîðàáëÿ " )
...
function r_talk178()
	...
	Talk( 1, "Ìå÷: Òû íå çàõîäèë åù¸ â ïîðòàë? Òàì ïðîèñõîäÿò îïàñíûå âåùè!" )
	InitTrigger()
	TriggerCondition( 1, HasAllBoatInBerth, 5 )
	TriggerAction( 1, LuanchBerthList, 5, 3240, 3314, 0 )
	TriggerFailure( 1, JumpPage, 3 )
	Text( 1, "Íåò, åù¸ íåáûë òàì.", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, HasLuanchOut )
	TriggerAction( 1, RepairBoat )
	...
	TriggerFailure( 2, JumpPage, 4 )
	Text( 1, "Íåà!", MultiTrigger, GetMultiTrigger(), 2 ) 
	InitTrigger()
	TriggerCondition( 1, HasLuanchOut )
	TriggerAction( 1, SupplyBoat )
	TriggerCondition( 2, HasBoatInBerth, 5 )
	...
	TriggerFailure( 1, JumpPage, 6 )
	Text( 1, "Ìíå ñòðàøíî!", MultiTrigger, GetMultiTrigger(), 1 ) 

        Talk( 3, "Íó òàê ñõîäè, ÷¸!" )
	Talk( 4, "Íå òóïè, èäè ïðîâåðü." )
	Talk( 5, "Ïðîâåðÿé, ÷¸ òóïèøü?!" )
	Talk( 6, "Ïõàõàõàõ, ëîë!" )
...
function r_talk210 ()
	...
	Talk( 1, "Ïðèâåò ìîðÿê, òåáå íóæåí êîðàáëü? Íó âûáåðàé." )
	InitTrigger()
	TriggerCondition( 1, IsBoatFull )
	TriggerAction( 1, SystemNotice, "Ships limit reached. Unable to build more ship" )
	TriggerFailure( 1, JumpPage, 2 )
	Text( 1, "Ñîçäàòü êîðàáëü ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, HasBoatInBerth, 2 )
	...
	Talk( 3, "Àòòàí: ×òîáû àïäåéòèòü ñâîé êîðàáëü, íàõîäèñü áîëüøå â ìîðå è óáèâàé ìîíñòðîâ, çà ýòî òåáå áóäóò äàâàòü êîðàáåëüíûé îïûò." )
end 
...
function r_talk211()
	...
	Talk( 1, "Ïðèâåò òû õî÷åøü âñòóïèòü â ãè èëè ñîçäàòü? íó íå ìîå äåëî, âûáèðàé." )
...
TriggerFailure( 1, JumpPage, 4 )
Text( 1, "Ñîçäàòü ãèëüäèþ ", MultiTrigger, GetMultiTrigger(), 1)
	...
	Text( 1, "Ïîñìîòðåòü ñïèñîê ÃÈ ", MultiTrigger, GetMultiTrigger(), 3)
	Text( 1, "Âûéòè ", CloseTalk)
...
Talk( 4, "Äåññàðî: ×òîáû ñîçäàòü ãèëüäèþ Ôëîòà âû äîëæíû çàïëàòèòü 100000 çîëîòà è ïðèíåñòè Êàìåíü êëÿòâû. òàê âû äîêàæåòå âàøó ïðåäàííîñòü. " )
...
------------------------------------------------------------
-- °×Òø³Ç-----º£¾üÄ¼±øÐ¡½ã¡¤ÀÙç²¶û
------------------------------------------------------------

function r_talk213()

	Talk( 1, "Ðåé÷åë: Ïðèâåò ÿ äàþ ðåêîìåíäàöèþ íà òåáÿ, íà òî ÷òî òû ïðèãîäåí äëÿ ãèëüäèè, õî÷åøü?" )
	InitTrigger()
	...
	Text( 1, "Äà, î÷åíü õî÷ó ",MultiTrigger, GetMultiTrigger(), 4 )
	Text( 1, "ß åùå íå ãîòîâ ", CloseTalk)
...
function r_talk263()
	...
	Talk( 1, "Ïðèâåò, ÿ âîçâðàùàþ ñ äàíæåé êîðàáëè." )
	InitTrigger()
	TriggerCondition( 1, HasAllBoatInBerth, 12 )
	TriggerAction( 1, LuanchBerthList, 12, 2261, 2825, 0 )
	TriggerFailure( 1, JumpPage, 2 )
	Text( 1, "Ïîïëûòü ", MultiTrigger, GetMultiTrigger(), 1 )
	InitTrigger()
	TriggerCondition( 1, HasLuanchOut )
	TriggerAction( 1, RepairBoat )
	TriggerCondition( 2, HasBoatInBerth, 12 )
	...
	TriggerAction( 2, SupplyBerthList, 12 )
	TriggerFailure( 2, JumpPage, 4 )
	Text( 1, "Çàïðàâèòü ", MultiTrigger, GetMultiTrigger(), 2 ) 
	InitTrigger()
	TriggerCondition( 1, HasDeadBoatInBerth, 12 )
	TriggerAction( 1, SalvageBerthList, 12 )
	TriggerFailure( 1, JumpPage, 5 )
	Text( 1, "Âîñòàíîâèòü ", MultiTrigger, GetMultiTrigger(), 1 ) 
...
function leo_talk10()	
	...
	--¶Ò»»ËùÐèÎïÆ· ID£¬ÊýÁ¿£¬¶Ò»»ËùµÃÎïÆ·ÊýÁ¿£¬¸³ÓèµÄÖµ
	InitExchange()
	--¼ÓÔØ8¸öµÀ¾ßÐÅÏ¢£¬ÔÚScriptSDKÀï
	DoExchange()
