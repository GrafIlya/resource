...
AREA_SAFE = 2		--安全区属性编号 
EXP_RAID = 80000	--怪物经验倍数
MF_RAID = 1		--怪物暴料倍数
Resource_RAID_ADJUST=1  --资源暴料倍数
TeamExp_RAID = 1	--组队额外经验倍数
ELEEXP_GETRAD = 1	--精灵挂机成长率
LV_LIMIT = 50		--进入跟踪的等级限制
A_B_C = 8	         --最大召唤只数
Money_all = 1000000		--进入乱斗白银城的累计金钱
How_Many_Active = 0	--地图关闭时存活的玩家数量
Every_5_minute = 0      --每5分钟程序执行次数
NOWTIME_TE=0
NOWTIME_YI=0
NOWTIME_HEI=0
JINISI_TIME=2100
...
Item_CanRepair_ID = { }
Item_CanRepair_ID [0]  =		1	--剑
Item_CanRepair_ID [1]  =		2	--巨剑
Item_CanRepair_ID [2]  =		3	--弓
Item_CanRepair_ID [3]  =		4	--火枪
Item_CanRepair_ID [4]  =		7	--匕首
Item_CanRepair_ID [5]  =		11	--盾牌
Item_CanRepair_ID [6]  =		20	--帽子
Item_CanRepair_ID [7]  =		22	--衣服
Item_CanRepair_ID [8]  =		23	--手套
Item_CanRepair_ID [9]  =		24	--鞋子
Item_CanRepair_ID [10] =		27	--纹身
Item_CanRepair_ID [11] =		9	--法杖
...
Item_CanJinglian_ID [0]  =		1	--剑
Item_CanJinglian_ID [1]  =		2	--巨剑
Item_CanJinglian_ID [2]  =		3	--弓
Item_CanJinglian_ID [3]  =		4	--火枪
Item_CanJinglian_ID [4]  =		7	--匕首
Item_CanJinglian_ID [5]  =		11	--盾牌
Item_CanJinglian_ID [6]  =		20	--帽子
Item_CanJinglian_ID [7]  =		22	--衣服
Item_CanJinglian_ID [8]  =		23	--手套
Item_CanJinglian_ID [9]  =		24	--鞋子
Item_CanJinglian_ID [10] =		27	--纹身
Item_CanJinglian_ID [11] =		9	--法杖


--宝石对应属性类型

StoneAttrType_Num = 16

StoneAttrType = {}
StoneAttrType [0]		=		0
StoneAttrType [1]		=		ITEMATTR_VAL_MNATK	--攻击
StoneAttrType [2]		=		ITEMATTR_VAL_MNATK	--攻击
StoneAttrType [3]		=		ITEMATTR_VAL_MNATK	--攻击
StoneAttrType [4]		=		ITEMATTR_VAL_HIT	--命中
StoneAttrType [5]		=		ITEMATTR_VAL_DEF	--防御
StoneAttrType [6]		=		ITEMATTR_VAL_MXHP	--最大HP
StoneAttrType [7]		=		ITEMATTR_VAL_FLEE	--回避
StoneAttrType [8]		=		ITEMATTR_VAL_STA	--精神
StoneAttrType [9]		=		ITEMATTR_VAL_AGI	--敏捷
StoneAttrType [10]		=		ITEMATTR_VAL_DEX	--专注
StoneAttrType [11]		=		ITEMATTR_VAL_CON	--体制
StoneAttrType [12]		=		ITEMATTR_VAL_STR	--力量
StoneAttrType [13]		=		ITEMATTR_VAL_MNATK	--攻击
StoneAttrType [14]		=		ITEMATTR_VAL_PDEF	--抵抗
StoneAttrType [15]		=		ITEMATTR_VAL_MXHP	--最大HP
StoneAttrType [16]		=		ITEMATTR_VAL_STA	--精神
-------------------------------------------------------------------
JNSTime_Flag_Num=13
JNSTime_Flag={}
JNSTime_Flag[1]				=0
...
STAR_ATTR_Num = 47
STAR_ATTR={}
STAR_ATTR[1]				=	"Strength modulus bonus   "	--力量系数加成             
STAR_ATTR[2]				=	"Agility modulus bonus            "	--敏捷系数加成             
STAR_ATTR[3]				=	"Accuracy modulus bonus   "	--专注系数加成             
STAR_ATTR[4]				=	"Constitution modulus bonus   "	--体质系数加成             
STAR_ATTR[5]				=	"Spirit modulus bonus   "	--精力系数加成             
STAR_ATTR[6]				=	"Luck modulus bonus   "	--幸运系数加成             
STAR_ATTR[7]				=	"攻击频率系数加成      "	--攻击频率系数加成       
STAR_ATTR[8]				=	"Attack Range modulus bonus"	--攻击距离系数加成       
STAR_ATTR[9]				=	"最小攻击力系数加成   "	--最小攻击力系数加成    
STAR_ATTR[10]				=	"最大攻击力系数加成   "	--最大攻击力系数加成    
STAR_ATTR[11]				=	"防御系数加成            "	--防御系数加成             
STAR_ATTR[12]				=	"Max HP modulus bonus  "	--最大Hp系数加成         
STAR_ATTR[13]				=	"Max SP modulus bonus  "	--最大Sp系数加成         
STAR_ATTR[14]				=	"Dodge modulus bonus  "	--闪避率系数加成          
STAR_ATTR[15]				=	"Hit Rate modulus bonus  "	--命中率系数加成          
STAR_ATTR[16]				=	"Berserk Rate modulus bonus  "	--爆击率系数加成          
STAR_ATTR[17]				=	"Treasure drop rate modulus bonus  "	--寻宝率系数加成          
STAR_ATTR[18]				=	"HP Recovery Rate modulus bonus "	--hp恢复速度系数加成   
STAR_ATTR[19]				=	"SP Recovery rate modulus bonus "	--sp恢复速度系数加成    
STAR_ATTR[20]				=	"Movement speed modulus bonus  "	--移动速度系数加成       
STAR_ATTR[21]				=	"Resource gathering rate modulus bonus"	--资源采集速度系数加成 
STAR_ATTR[22]				=	"Physical resist modulus bonus      "	--物理抵抗系数加成       
STAR_ATTR[23]				=	"无                           "	--无                            
STAR_ATTR[24]				=	"无                           "	--无                            
STAR_ATTR[25]				=	"无                           "	--无                            
STAR_ATTR[26]				=	"Strength constant bonus   "	--力量常数加成             
STAR_ATTR[27]				=	"Agility constant bonus   "	--敏捷常数加成             
STAR_ATTR[28]				=	"Accuracy constant bonus   "	--专注常数加成             
STAR_ATTR[29]				=	"Constitution constant bonus   "	--体质常数加成             
STAR_ATTR[30]				=	"Spirit constant bonus   "	--精力常数加成             
STAR_ATTR[31]				=	"Luck constant bonus            "	--幸运常数加成             
STAR_ATTR[32]				=	"Hit Rate constant bonus"	--攻击频率常数加成       
STAR_ATTR[33]				=	"攻击距离常数加成      "	--攻击距离常数加成       
STAR_ATTR[34]				=	"最小攻击力常数加成   "	--最小攻击力常数加成    
STAR_ATTR[35]				=	"最大攻击力常数加成   "	--最大攻击力常数加成    
STAR_ATTR[36]				=	"Defense constant bonus"	--防御常数加成             
STAR_ATTR[37]				=	"Max HP constant bonus   "	--最大Hp常数加成         
STAR_ATTR[38]				=	"Max SP constant bonus   "	--最大Sp常数加成         
STAR_ATTR[39]				=	"Dodge constant bonus   "	--闪避率常数加成          
STAR_ATTR[40]				=	"Hit Rate constant bonus   "	--命中率常数加成          
STAR_ATTR[41]				=	"Berserk rate constant bonus   "	--爆击率常数加成          
STAR_ATTR[42]				=	"Treasure drop rate constant bonus   "	--寻宝率常数加成          
STAR_ATTR[43]				=	"HP Recovery Rate constant bonus "	--hp恢复速度常数加成   
STAR_ATTR[44]				=	"SP Recovery Rate constant bonus "	--sp恢复速度常数加成    
STAR_ATTR[45]				=	"Movement speed constant bonus  "	--移动速度常数加成       
STAR_ATTR[46]				=	"Resource gathering rate constant bonus"	--资源采集速度常数加成 
STAR_ATTR[47]				=	"Physical Resist constant bonus  "	--物理抵抗常数加成       
--------------------------------------------------------------------字母都他妈是字母
WORD_Num = 52
WORD={}
WORD[1]="A"
...
StoneTpye_ID = {}
StoneTpye_ID [0]	=		0		--空位
StoneTpye_ID [1]	=		0878		--烈炎石
StoneTpye_ID [2]	=		0879		--炙焰石
StoneTpye_ID [3]	=		0880		--火药石
StoneTpye_ID [4]	=		0881		--玛瑙石
StoneTpye_ID [5]	=		0882		--寒玉
StoneTpye_ID [6]	=		0883		--月之心
StoneTpye_ID [7]	=		0884		--水灵石
StoneTpye_ID [8]	=		0887		--圣光石
StoneTpye_ID [9]	=		0860		--风灵石
StoneTpye_ID [10]	=		0861		--鹰眼石
StoneTpye_ID [11]	=		0862		--岩玉
StoneTpye_ID [12]	=		0863		--炎玉
StoneTpye_ID [13]	=		0864		--黑龙之瞳
StoneTpye_ID [14]	=		0865		--黑龙之魂
StoneTpye_ID [15]	=		0866		--黑龙之心
StoneTpye_ID [16]	=		1012		--加纳之神
...
StoneEffType = {}
StoneEffType[0] =		0	--空
StoneEffType[1] =		1	--攻击型
StoneEffType[2] =		1	--攻击型
StoneEffType[3] =		1	--攻击型
StoneEffType[4] =		1	--攻击型
StoneEffType[5] =		2	--防御型
StoneEffType[6] =		2	--防御型
StoneEffType[7] =		2	--防御型
StoneEffType[8] =		4	--增益型
StoneEffType[9] =		4	--增益型
StoneEffType[10] =		4	--增益型
StoneEffType[11] =		4	--增益型
StoneEffType[12] =		4	--增益型
StoneEffType[13] =		1	--攻击型
StoneEffType[14] =		2	--防御型
StoneEffType[15] =		2	--防御型
StoneEffType[16] =		4	--增益型
...
StoneItemType[16] =  { 1,2,3,4,7,9,0 }
