...
Talk( 1,  "Помощник: Привет, у меня можно изучать умения для игроков ! Но тебе сперва нужно взять вторую профессию." )
Text( 1,  "Изучить навыки ", AddSkillNPC)
...
Talk( 2,  "Что бы изучить навыки ты должен быть не ниже 45 уровня." )
...
function fargite () 
	...
	Talk( 1, "Гид по серверу: Привет, если ты новенький, то я смогу всё рассказать тебе о Flaming Devil. Спрашивай =)" )
	Text( 1,  "Кто Вы? ",JumpPage, 3 )
	Text( 1,  "С чего мне начать? ",JumpPage, 4 )
	Text( 1,  "Где найти Фей и Одежду  ",JumpPage, 5 )
	Text( 1,  "Где взять гемы, рефы? ", JumpPage, 6 )
	Text( 1,  "Где взять деньги? ", JumpPage, 7 )
	Text( 1,  "Как разделить Лут по 99 шт? ", JumpPage, 8 )
	Text( 1,  "Где взять Купюры по 1000 руб.? ", JumpPage, 9 )
	Text( 1,  "Где взять Лут на VIP Шмот ", JumpPage, 10 )


        Talk( 3, "Я отвечаю на вопросы жителей Flaming Devil. Если у Вас возникли какие то трудности, то ищите меня :)" )
	...
	Talk( 6,  "В Аргенте рядом с кузнецом . Так же выбивай деньги в шахтах и меняй на гемы +6 у кузнеца. " )
	...
	Talk( 8,  "Как тут стекуются , спросишь ты?! Стекуются они по 1500. Если тебе нужно разделить их на 99, чтобы было удобнее торговать с игроками, то положи максимальное количество своих келей в банк, а потом с банка перетаскивай в разные ячейки инвертаря по 99 шт. " )
	Text( 8,  "Назад. ", JumpPage, 1)
	Talk( 9,  "Если ты новичёк, то тебе лучше идти в лут-зону, попасть в неё можно через портальщика Хоть куда. Находится он на левом выходе аргента. Там с мобов ты будешь выбивать денежку) " )
	Text( 9,  "Назад. ", JumpPage, 1)
	Talk( 10,  "Данный лут ты сможешь достать в Авроре с мобов и сундуков. Попасть туда можно воспользовавшись телепортов на левом выходе аргента ! " )
...
function Usdgas()
Talk( 1, "Очень Сложная Фарм Зона!!! ...")
Text( 1, "В данж ", GoTo, 38, 34, "darkswamp" )

Text( 1, "Я Хочу Шапку 228 ", JumpPage, 3)


Talk(3," 350 Алмазов Охранника , 1500 Костей , 5 Драгоценных Писем , 800 Монет величия ")
InitTrigger()

TriggerCondition( 1, HasItem,7471,350 )
TriggerCondition( 1, HasItem,271,1500 )
TriggerCondition( 1, HasItem,7458,5 )
TriggerCondition( 1, HasItem,7445,800 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
TriggerAction( 1, TakeItem, 7471,350 )
TriggerAction( 1, TakeItem, 271,1500 )
TriggerAction( 1, TakeItem, 7458,5 )
TriggerAction( 1, TakeItem, 7445,800 )

TriggerAction( 1, GiveItem, 35,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(3," Давай мне Шапку 228 ",MultiTrigger,GetMultiTrigger(),1)

end

function Usdgas22()

Talk( 1, "Здравствуй, я обменник 2 -3 РБ. " )



	Text( 1, "Я хочу Получить 2 Перерождение ", JumpPage, 6)
    Text( 1, "Я хочу Получить 3 Перерождение ", JumpPage, 7)
	Talk( 6, "Привет , чтобы получить 2 рб тебе придется попотеть !? Ты должен быть сильным и принести мне 10 Шишечек !! Их ты сможешь достать с главного боса хаоса , который появляется с первой волной честов у фт ! Желаю Удачи !" )
	Text( 6, "Я Буду Мечником ! ", GetChaName1_born2, 1)
	Text( 6, "Я Буду Чемпионом ! ", GetChaName2_born2, 1)
	Text( 6, "Я Буду Воем ! ", GetChaName3_born2, 1)
	Text( 6, "Я Буду Шарпом ! ", GetChaName4_born2, 1)
	Text( 6, "Я Буду Целителем ! ", GetChaName5_born2, 1)
	Text( 6, "Я Буду Ведьмой ! ", GetChaName6_born2, 1)
	Text( 6, "Я ухожу , не туда зашел !", CloseTalk)

Talk( 7, "Привет , чтобы получить 3 рб тебе придется попотеть !? Ты должен быть сильным и принести мне 10 карт D !!  Желаю Удачи !" )
	Text( 7, "Я Буду Мечником ! ", GetChaName1_born3, 1)
	Text( 7, "Я Буду Чемпионом ! ", GetChaName2_born3, 1)
	Text( 7, "Я Буду Воем ! ", GetChaName3_born3, 1)
	Text( 7, "Я Буду Шарпом ! ", GetChaName4_born3, 1)
	Text( 7, "Я Буду Целителем ! ", GetChaName5_born3, 1)
	Text( 7, "Я Буду Ведьмой ! ", GetChaName6_born3, 1)
	Text( 7, "Я ухожу , не туда зашел !", CloseTalk)
...
Talk( 1, " Привет , ты похоже хочешь у меня что-то забарыжить , пссс , бери товар и расходимся!  " )
Text( 1, " Неистовая Фея ", JumpPage, 24)
Text( 1, " Анжела Мл. ", JumpPage, 2)
Text( 1, " Фрукты Для Фей ", JumpPage, 4)
Text( 1, " Яблоки  ", JumpPage, 17)
Text( 1, " Шишечки ", JumpPage, 20)
Text( 1, " Бошки ", JumpPage, 21)
Text( 4, " Фрукты 100-145 ", JumpPage, 5)
Text( 4, " Фрукты 145-180 ", JumpPage, 11)
	Talk( 5, " За 1 Шишку которую можно выбить в хс у фт с Боса ты можешь взять 4 фрукта " )
	Text( 5, " Фрукт Стр ", JumpPage, 6)
	Text( 5, " Фрукт Акк ", JumpPage, 7)
	Text( 5, " Фрукт Кон ", JumpPage, 8)
	Text( 5, " Фрукт Аги ", JumpPage, 9)
	Text( 5, " Фрукт Дух ", JumpPage, 10)
	Talk( 11, " За 1 Бошку которую можно выбить в хаосе аргента с боса у фт на бд волне я дам тебе 1 фрукт   " )
	Text( 11, " Фрукт Стр ", JumpPage, 12)
	Text( 11, " Фрукт Акк ", JumpPage, 13)
	Text( 11, " Фрукт Кон ", JumpPage, 14)
	Text( 11, " Фрукт Аги ", JumpPage, 15)
	Text( 11, " Фрукт Дух ", JumpPage, 16)
	
Talk( 2, " Анжела Мл. это Умная фея , качай ее правильно . Пример 177 стр , 1аги , 1 кон , 1дух . Работает умная фея ! Такая фея тебе обойдется в 10 Бошек , 10 Шишек " )
Text( 2, " Купить ", JumpPage, 3)

Talk(17," 5 яблок за 1 шишку и 1 бошку  ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasItem,271,10 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
TriggerAction( 1, TakeItem, 7490,1 )
TriggerAction( 1, TakeItem, 7491,1 )
TriggerAction( 1, TakeItem, 271,10 )
TriggerAction( 1, GiveItem, 7501,5,4 )
TriggerFailure( 1, JumpPage, 19)
Text(17," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(24," 600 Эмблем Неистовой Феи , 200 Монет Добра , 5 Яиц Дракона, 20 Шишек и бошек , 10 Останков охраны ")
InitTrigger()
TriggerCondition( 1, HasItem,7706,10 )
TriggerCondition( 1, HasItem,7703,500 )
TriggerCondition( 1, HasItem,7704,200 )
TriggerCondition( 1, HasItem,7506,5 )
TriggerCondition( 1, HasItem,7490,20 )
TriggerCondition( 1, HasItem,7491,20 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
TriggerAction( 1, TakeItem, 7706,10 )
TriggerAction( 1, TakeItem, 7703,500 )
TriggerAction( 1, TakeItem, 7704,200 )
TriggerAction( 1, TakeItem, 7506,5 )
TriggerAction( 1, TakeItem, 7490,20 )
TriggerAction( 1, TakeItem, 7491,20 )
TriggerAction( 1, GiveItem, 68,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(24," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)


Talk(20," 1 Шишечка за 5 Яблок и 10 Монет Фей  ")
InitTrigger()
TriggerCondition( 1, HasItem,7501,5 )
TriggerCondition( 1, HasItem,855,10 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
TriggerAction( 1, TakeItem, 7501,5 )
TriggerAction( 1, TakeItem, 855,10 )
TriggerAction( 1, GiveItem, 7490,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(20," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(21," 1 Шишечка за 5 Яблок и 10 Монет Фей ")
InitTrigger()
TriggerCondition( 1, HasItem,7501,5 )
TriggerCondition( 1, HasItem,855,10 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
...
TriggerAction( 1, TakeItem, 7501,5 )
TriggerAction( 1, TakeItem, 855,10 )
TriggerAction( 1, GiveItem, 7491,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(21," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(3," Уходи , пока нас не спалили! ")
InitTrigger()
...
TriggerAction( 1, GiveItem, 48,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(3," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(6," Давай шишку и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7486,4,4 )
TriggerFailure( 1, JumpPage, 19)
Text(6," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(7," Давай шишку и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7488,4,4 )
TriggerFailure( 1, JumpPage, 19)
Text(7," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(8," Давай шишку и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7487,4,4 )
TriggerFailure( 1, JumpPage, 19)
Text(8," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(9," Давай шишку и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7485,4,4 )
TriggerFailure( 1, JumpPage, 19)
Text(9," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(10," Давай шишку и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7490,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7489,4,4 )
TriggerFailure( 1, JumpPage, 19)
Text(10," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(12," Давай Бошки и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7431,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(12," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(13," Давай Бошки и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7433,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(13," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(14," Давай Бошки и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7419,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(14," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(15," Давай Бошки и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7430,1,4 )
TriggerFailure( 1, JumpPage, 19)
Text(15," Спасибо! ",MultiTrigger,GetMultiTrigger(),1)

Talk(16," Давай Бошки и уходи , пока нас не спалили! ")
InitTrigger()
TriggerCondition( 1, HasItem,7491,1 )
TriggerCondition( 1, HasLeaveBagGrid, 1 )
TriggerCondition( 1, KitbagLock, 0 )
...
TriggerAction( 1, GiveItem, 7434,1,4 )
TriggerFailure( 1, JumpPage, 19)
...
function GoToWhere1()
	...
	Text(1, " В Новогодний Данж ", GoTo, 42, 36, "kyjj_1")
