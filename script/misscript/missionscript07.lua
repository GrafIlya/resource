...
----------------------------------奥运活动 之 仁爱之心6------------圣火传递大使	 （结束）
	...
	DefineMission( 123123, "Фрукт Силы ", 123124 )

MisBeginTalk( "<t>Принеси мне Шишечки а я тебе фрукт апа феи 100-145 со 100% шансом! Можно выбить в хс у фт с босса " )
MisBeginCondition(NoMission, 123124)
--Выбрана возможность многоразового выполнения квеста
MisBeginAction(AddMission, 123124)
MisBeginAction(SetFlag, 123124, 1)
MisBeginAction(AddTrigger, 1231241, TE_GETITEM, 7490, 1 )
MisCancelAction(ClearMission, 123124)

MisNeed(MIS_NEED_DESP, "Выполняй , Брат ! ")
MisNeed(MIS_NEED_ITEM, 7490, 1, 10, 1)

MisPrize(MIS_PRIZE_ITEM, 7486, 2, 4)
MisPrizeSelAll()

MisResultTalk("<t>Ты смог Братишка! ")
MisHelpTalk("<t>Фарми брат , Шишки можно выбить в хс с боса у фт ")

MisResultCondition(HasMission, 123124)
MisResultCondition(HasItem, 7490, 1 )
MisResultAction(TakeItem, 7490, 1 )
MisResultAction(ClearMission, 123124)
MisResultAction(SetRecord, 123124)
MisResultBagNeed(1)

InitTrigger()
TriggerCondition( 1, IsItem, 7490 )
TriggerAction( 1, AddNextFlag, 123124, 10, 1 )
RegCurTrigger( 1231241 )
