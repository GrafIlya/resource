...
function get_map_entry_pos_guildwar()   --Координаты портала
...
function init_entry(map)
    SetMapEntryMapName(map, "magicsea")   --Регион портала
...
--	SetChaSideID(cha, 1)
--	local cha=CreateChaEx(1006, 52023, 10362, 145, 20000,map_copy)--єЈѕьОьД§
--	SetChaSideID(cha, 1)
...
--	SetChaSideID(cha, 1)
--	--local cha=CreateChaEx(1004, 30117, 52848, 355, 20000)
--	--SetChaSideID(cha, 2)
--	--local cha=CreateChaEx(1004, 31576, 52807, 355, 20000)
--	--SetChaSideID(cha, 2)
...
--	SetChaSideID(cha, 2)
--	--local cha=CreateChaEx(1003, 29924, 9911, 145, 20000)--ёЯј¶
--	--SetChaSideID(cha, 1)
...
--	SetChaSideID(cha, 2)
--	--local cha=CreateChaEx(1003, 31413, 9925, 145, 20000)--ёЯј¶
--	--SetChaSideID(cha, 1)
