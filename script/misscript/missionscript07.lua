print( "‡ Јаг§Є  MissionScript07.lua" )
	...
	DefineMission( 900, "Соревнование фей ", 900)--получение фейки
...
----------------------------
	...
	DefineMission(901,"\Соревнование фей ",901)--получение фейки
...
----------------------------
	...
	DefineMission( 902, "Чтобы победить зло на Драконьем Лодочном фестивале, используй китайскую Клецку, серу и Небесный клевер ", 902 )
	...
	DefineMission( 903, "Чтобы победить зло на Драконьем Лодочном фестивале, используй китайскую Клецку, серу и Небесный клевер ", 903 )
	...
	DefineMission( 904, "Чтобы победить зло на Драконьем Лодочном фестивале, используй китайскую Клецку, серу и Небесный клевер ", 904 )
	...
	DefineMission( 907, "Любовь к лунным пирогам ", 906 )
	...
	DefineMission( 908, "Письмо Цветочка ", 906, COMPLETE_SHOW )
	...
	DefineMission( 909, "Отворотное зелье ", 907 )
	...
	DefineMission( 910, "Приготовить Отворотное зелье ", 908 )
	...
	DefineMission( 911, "Купить Нефритовый пузырек бутылка ", 908, COMPLETE_SHOW )
	...
	DefineMission ( 912, "Микстура Любви ", 909)
	...
	DefineMission( 913, "Микстура Любви ", 909, COMPLETE_SHOW )
	...
	DefineMission ( 914, "Приготовление Микстуры Любви ", 910 )
	...
	DefineMission ( 915, "Купите Золотую Нефритовую Бутылку ", 911 )
	...
	DefineMission( 918, "Возрождение Любви ", 914 )
...
-------------------------------------------------Телец
	...
	DefineMission( 5624, "Посол Кровавого Тельца ", 1130 )
...
-----------------------------------------Посол
	...
	DefineMission( 5625, "Посол ", 1130, COMPLETE_SHOW )
	...
	DefineMission( 5626, "Посол 2", 1131 )
...
-----------------------------------------Посол
	...
	DefineMission(5627, "Посол 2", 1131, COMPLETE_SHOW )
	...
	DefineMission( 5628, "Посол 3", 1132 )
...
-----------------------------------------Посол
	...
	DefineMission(5629, "Посол 3", 1132, COMPLETE_SHOW )
	...
	DefineMission( 5630, "Посол 4", 1133 )
...
-----------------------------------------Посол
	...
	DefineMission( 5631, "Посол 4", 1133, COMPLETE_SHOW )
	...
	DefineMission( 5632, "Посол 5", 1134 )
...
-----------------------------------------Посол
	...
	DefineMission(5633, "Посол 5", 1134, COMPLETE_SHOW )
	...
	DefineMission( 5634, "Посол 6", 1135 )
...
-----------------------------------------Посол
	...
	DefineMission(5635, "Посол 6", 1135, COMPLETE_SHOW )
	...
	DefineMission( 5636, "Посол 7", 1136 )
...
-----------------------------------------Посол
	...
	DefineMission(5637, "Посол 7", 1136, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5638, "Посол 8", 1137 )
...
-----------------------------------------Посол
	...
	DefineMission(5639, "Посол 8", 1137, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5640, "Посол 9", 1138 )
...
-----------------------------------------Посол
	...
	DefineMission(5641, "Посол 9", 1138, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5642, "Посол 10", 1139 )
...
-----------------------------------------Посол
	...
	DefineMission(5643, "Посол 10", 1139, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5644, "Посол 11", 1140 )
...
-----------------------------------------Посол
	...
	DefineMission(5645, "Посол 11", 1140, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5646, "Посол 12", 1141 )
...
-----------------------------------------Посол
	...
	DefineMission(5647, "Посол 12", 1141, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5648, "Посол 13", 1142 )
...
-----------------------------------------Посол
	...
	DefineMission(5649, "Посол 13", 1142, COMPLETE_SHOW )
...
-----------------------------------------Посол
	...
	DefineMission( 5650, "Посол 14", 1143 )
...
--	MisResultTalk ( "<t>Нетерпите покинуть тюрьму? Я не думаю что здесь настолько скучно, ха-ха. Если Вы действительно хотите покинуть это место, то слушайтесь меня")
	...
	MisResultAction(SetRecord, 1281)
	...
	MisResultAction(GiveItem, 5786, 1, 4)
	MisResultBagNeed(1)
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5791, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	...
	MisResultAction(SetRecord, 1282)
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5792, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	...
	MisResultAction(SetRecord, 1283)   
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5793, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	MisBeginCondition(NoItem, 5790, 1)
	MisBeginAction(TakeItem, 5793, 1 )
	...
	MisResultAction(SetRecord, 1284)  
	
	MisResultAction(GiveItem, 5787, 1, 4)
	MisResultBagNeed(1)
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5794, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	MisBeginCondition(NoItem, 5790, 1)
	MisBeginAction(TakeItem, 5794, 1 )
	...
	MisResultCondition(HasItem, 0855, 99 )
	MisResultCondition(HasCredit, 1000 )
	MisResultCondition(HasHonorPoint, 50 )
	MisResultAction(TakeItem, 4511, 30 )
	MisResultAction(TakeItem, 0855, 99 )
	MisResultAction(ClearMission, 1285)
	MisResultAction(SetRecord, 1285)
	
	MisResultAction(GiveItem, 5788, 1, 4)
	MisResultBagNeed(1)
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5795, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	MisBeginCondition(NoItem, 5790, 1)
	MisBeginAction(TakeItem, 5795, 1 )
	...
	MisResultAction(SetRecord, 1286) 
	
	MisResultAction(GiveItem, 5789, 1, 4)
	MisResultBagNeed(1)
	...
	MisBeginCondition(NoRecord, 1286)
	MisBeginCondition(NoRecord, 1287)
	MisBeginCondition(HasItem, 5796, 1)
	MisBeginCondition(NoItem, 5786, 1)
	MisBeginCondition(NoItem, 5787, 1)
	MisBeginCondition(NoItem, 5788, 1)
	MisBeginCondition(NoItem, 5789, 1)
	MisBeginCondition(NoItem, 5790, 1)
	MisBeginAction(TakeItem, 5796, 1 )
	...
	MisResultAction(SetRecord, 1287)
	
	MisResultAction(GiveItem, 5790, 1, 4)
	MisResultBagNeed(1)
...
------------------------------------Возвращение------------
	...
	MisResultBagNeed(1)
		...
		---------------------------------Докозательство
	DefineMission( 6629, "Докозательство ", 1920 )
...
------------------Знакомство  со странником
	DefineMission( 2000, "Знакомство  со странником ", 2000 )
...
----------------------------Начало длинного пути
	DefineMission( 2001, "Начало длинного пути ", 2001 )
...
-----------------------------------Доказательство героя
	DefineMission( 2002, "Доказательство героя ", 2002 )
...
-----------------------------------Посвещённая Жрица в тайны Богов
	DefineMission( 2003, "Посвещённая Жрица в тайны Богов ", 2003 )
...
-- Правда о Богине
	DefineMission( 2004, "Правда о Богине ", 2004 )
...
--Правда о Богине
	DefineMission( 2005, "Правда о Богине ", 2004, COMPLETE_SHOW )
...
-- Самая простоя задача
	DefineMission( 2006, "Самая простоя задача ", 2005 )
...
-- С небес на землю
	DefineMission( 2007, "С небес на землю ", 2006 )
...
-- С небес на землю
	DefineMission( 2008, "С небес на землю ", 2006, COMPLETE_SHOW )
...
-- Я буду молиться за Вас
	DefineMission( 2009, "Я буду молиться за Вас ", 2007 )
...
-- Противоядие
	DefineMission( 2073, "Противоядие ", 2008 )
...
-- Противоядие
	DefineMission( 2074, "Противоядие ", 2008, COMPLETE_SHOW )
...
-- Забытый рецепт
	DefineMission( 2075, "Забытый рецепт ", 2009 )
...
-- Забытый рецепт
	DefineMission( 2076, "Забытый рецепт ", 2009, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure)
...
--Опять эта память подводит
	DefineMission( 2077, "Опять эта память подводит ", 2010 )
...
--Ура! Память вернулась
	DefineMission( 2078, "Ура! Память вернулась ", 2011 )
...
-- Ура! Память вернулась
	DefineMission( 2079, "Ура! Память вернулась ", 2011, COMPLETE_SHOW )
...
-- Приготовление противоядия
	DefineMission( 2080 ,"Приготовление противоядия ", 2012 )
...
-- Приготовление противоядия
	DefineMission( 2081, "Приготовление противоядия ", 2012, COMPLETE_SHOW )
...
-- Пот снежного люда
	DefineMission( 2082, "Пот снежного люда ", 2013 )
...
--Опять проклятые монстры
	...
	DefineMission( 2083, "Опять проклятые монстры ", 2014 )
...
--Опять проклятые монстры
	DefineMission( 2084, "Опять проклятые монстры ", 2014, COMPLETE_SHOW )
...
--Страх ребёнка
	DefineMission( 2085, "Страх ребёнка ", 2015 )
...
--Боги Вам улыбаются
	DefineMission( 2086, "Боги Вам улыбаются ", 2016 )
...
-- Боги Вам улыбаются
	DefineMission( 2087, "Боги Вам улыбаются ", 2016, COMPLETE_SHOW )
...
-- Опять повезло
	DefineMission( 2088, "Опять повезло ", 2017 )
...
-- Опять повезло
	DefineMission( 2089, "Опять повезло ", 2017, COMPLETE_SHOW )
...
-- Перерождение
	DefineMission( 2090, "Перерождение ", 2018 )
...
-- Перерождение
	DefineMission( 2091, "Перерождение ", 2018, COMPLETE_SHOW )
...
----------------------------За рунами!-------------------------------------------	
	...
	DefineMission( 2092, "За рунами! ", 2019 )--реберн стандарт
