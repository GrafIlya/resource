...
Snow_BOSS		= 0			-- Переменная босса в локации Снежная Война
...
---------------------------------------------------------------
-- Похоже на переменные из карты xmas07, которая не работает --
---------------------------------------------------------------
CheckBoss1Dead	= 1
XmasMonsterNum1	= 0
CheckBoss2Dead	= 1
...
AddonSystem						= {}
AddonSystem["ProtectGMCommand"]	= 1
AddonSystem["AntiDupe"]			= 1
AddonSystem["Teleport"]			= 1

TeleportList	= {}
TeleportList[	1	]	= { "garner",			2232,	2787	}	-- Аргент
TeleportList[	2	]	= { "garner",			2194,	2779	}	-- Аргент
TeleportList[	3	]	= { "garner",			2245,	2703	}	-- Аргент

TeleportList[	4	]	= { "garner",			736,	1592	}	-- Громоград
TeleportList[	5	]	= { "garner",			768,	1539	}	-- Громоград
TeleportList[	6	]	= { "garner",			738,	1454	}	-- Громоград

TeleportList[	7	]	= { "magicsea",			891,	3575	}	-- Шайтан
TeleportList[	8	]	= { "magicsea",			819,	3654	}	-- Шайтан
TeleportList[	9	]	= { "magicsea",			845,	3502	}	-- Шайтан

TeleportList[	10	]	= { "darkblue",			1316,	536		}	-- Ледынь
TeleportList[	11	]	= { "darkblue",			1342,	481		}	-- Ледынь
TeleportList[	12	]	= { "darkblue",			1305,	503		}	-- Ледынь

TeleportList[	13	]	= { "darkblue",			471,	3407	}	-- Остров Арены
TeleportList[	14	]	= { "darkblue",			401,	3464	}	-- Остров Арены
TeleportList[	15	]	= { "darkblue",			463,	3461	}	-- Остров Арены
TeleportList[	16	]	= { "darkblue",			457,	3434	}	-- Остров Арены
TeleportList[	17	]	= { "darkblue",			426,	3435	}	-- Остров Арены

-- Прилегающие к Аргенту селения
TeleportList[	18	]	= { "garner",			633,	2100	}	-- Холдейский Ополот
TeleportList[	19	]	= { "garner",			1007,	2966	}	-- Андийский Лес
TeleportList[	20	]	= { "garner",			1903,	2807	}	-- Заброшенная шахта
TeleportList[	21	]	= { "garner",			1517,	3091	}	-- Скалистый удел
TeleportList[	22	]	= { "garner",			1120,	2773	}	-- Валхалла
TeleportList[	23	]	= { "garner",			535,	2433	}	-- Обитель радости

-- Прилегающие к Шайтану селения
TeleportList[	24	]	= { "magicsea",			787,	3121	}	-- Гавань Оазиса
TeleportList[	25	]	= { "magicsea",			1214,	3203	}	-- Роща Акаций

-- Прилегающие к Ледыни селения
TeleportList[	26	]	= { "darkblue",			807,	360		}	-- Пустошь Ледыни
TeleportList[	27	]	= { "darkblue",			1050,	656		}	-- Бухта Атлантис
TeleportList[	28	]	= { "darkblue",			2146,	542		}	-- Берег Скелетов
TeleportList[	29	]	= { "darkblue",			2681,	647		}	-- Ледяной шип

-- Острова Аскарона
TeleportList[	30	]	= { "garner",			3260,	3280	}	-- Остров Зефира
TeleportList[	31	]	= { "garner",			2273,	1122	}	-- Ледниковый остров
TeleportList[	32	]	= { "garner",			3590,	755		}	-- Остров Отверженных

-- Острова Шайтана
TeleportList[	33	]	= { "magicsea",			2376,	725		}	-- Остров Стужи
TeleportList[	34	]	= { "magicsea",			1730,	3775	}	-- Остров Канареек
TeleportList[	35	]	= { "magicsea",			2527,	2399	}	-- Остров Купидона

-- Острова Ледыни
TeleportList[	36	]	= { "darkblue",			1631,	1974	}	-- Остров Удачи

-- Сад Эдель
TeleportList[	37	]	= { "secretgarden",		54,		50		}
TeleportList[	38	]	= { "secretgarden",		430,	437		}

-- ДС
TeleportList[	39	]	= { "darkswamp",		55,		65		}

-- ФС
TeleportList[	40	]	= { "abandonedcity",	37,		43		}
TeleportList[	41	]	= { "abandonedcity2",	25,		24		}
TeleportList[	42	]	= { "abandonedcity2",	26,		469		}
TeleportList[	43	]	= { "abandonedcity2",	456,	466		}
TeleportList[	44	]	= { "abandonedcity2",	462,	25		}
TeleportList[	45	]	= { "abandonedcity3",	244,	224		}

-- Мир Демонов
TeleportList[	46	]	= { "puzzleworld",		36,		20		}
TeleportList[	47	]	= { "puzzleworld",		522,	32		}
TeleportList[	48	]	= { "puzzleworld",		36,		527		}
TeleportList[	49	]	= { "puzzleworld",		510,	527		}

-- Мир Демонов 2
TeleportList[	50	]	= { "puzzleworld2",		26,		23		}
TeleportList[	51	]	= { "puzzleworld2",		26,		521		}
TeleportList[	52	]	= { "puzzleworld2",		513,	518		}
TeleportList[	53	]	= { "puzzleworld2",		518,	28		}

-- Билеты
TeleportList[	54	]	= { "garner",			743,	1586	}	-- Громоград
TeleportList[	55	]	= { "garner",			990,	1263	}	-- Порт Громограда
TeleportList[	56	]	= { "garner",			914,	1072	}	-- Священная снежная гора
TeleportList[	57	]	= { "garner",			1018,	2975	}	-- Андийский Лес
TeleportList[	58	]	= { "magicsea",			804,	3115	}	-- Гавань Оазиса
TeleportList[	59	]	= { "darkblue",			2697,	638		}	-- Ледяной шип
TeleportList[	60	]	= { "garner",			271,	1775	}	-- Вход в Одинокую башню
TeleportList[	61	]	= { "magicsea",			1369,	3033	}	-- Вход в Пустую пещеру
TeleportList[	62	]	= { "eastgoaf",			116,	28		}	-- Заброшенные шахты 2
TeleportList[	63	]	= { "eastgoaf",			238,	27		}	-- Серебряные шахты 2
TeleportList[	64	]	= { "eastgoaf",			382,	123		}	-- Серебряные шахты 3
TeleportList[	65	]	= { "garner",			1642,	2698	}	-- Заброшенные шахты 1
TeleportList[	66	]	= { "lonetower",		35,		21		}	-- Одинокая башня 2
TeleportList[	67	]	= { "lonetower",		120,	406		}	-- Одинокая башня 3
TeleportList[	68	]	= { "lonetower",		320,	175		}	-- Одинокая башня 4
TeleportList[	69	]	= { "lonetower",		483,	121		}	-- Одинокая башня 5
TeleportList[	70	]	= { "lonetower",		494,	297		}	-- Одинокая башня 6

-- Арена
TeleportList[	71	]	= { "teampk",			44,		21		}
TeleportList[	72	]	= { "teampk",			44,		66		}
TeleportList[	73	]	= { "teampk",			20,		44		}
TeleportList[	73	]	= { "teampk",			66,		44		}

-- Бар Аргента
TeleportList[	74	]	= { "garner",			2207,	2887	}

TeleportList[	75	]	= { "darkblue",			3323,	2507	}	-- Весноград
TeleportList[	76	]	= { "darkblue",			3681,	2653	}	-- Остров Лета
TeleportList[	77	]	= { "darkblue",			2635,	3004	}	-- Остров Осени
TeleportList[	78	]	= { "jialebi",			620,	951		}	-- Залив Сокровищ
TeleportList[	79	]	= { "jialebi",			153,	905		}	-- Абаддон 4

-- Хаос Аргента
TeleportList[	80	]	= { "garner2",			100,	100		}
TeleportList[	81	]	= { "garner2",			72,		134		}
TeleportList[	82	]	= { "garner2",			66,		37		}
TeleportList[	83	]	= { "garner2",			151,	31		}
TeleportList[	84	]	= { "garner2",			201,	32		}
TeleportList[	85	]	= { "garner2",			212,	99		}
TeleportList[	86	]	= { "garner2",			248,	176		}
TeleportList[	88	]	= { "garner2",			184,	201		}
TeleportList[	89	]	= { "garner2",			150,	208		}
TeleportList[	90	]	= { "garner2",			123,	257		}
TeleportList[	91	]	= { "garner2",			136,	133		}

-- Абаддоны
TeleportList[	92	]	= { "hell",				100,	33		}	-- Абаддон с 5 по 8
TeleportList[	93	]	= { "hell",				36,		33		}	-- Абаддон с 5 по 8
TeleportList[	94	]	= { "hell",				99,		93		}	-- Абаддон с 5 по 8
TeleportList[	95	]	= { "hell2",			18,		75		}	-- Абаддон 9
TeleportList[	96	]	= { "hell3",			191,	209		}	-- Абаддон с 10 по 17
TeleportList[	97	]	= { "hell4",			57,		79		}	-- Абаддон 18
TeleportList[	98	]	= { "hell5",			20,		79		}	-- Вечный Абаддон

-- Мираж Громограда
TeleportList[	99	]	= { "leiting2",			55,		59		}

-- Мираж Шайтана
TeleportList[	100	]	= { "shalan2",			231,	184		}

-- Мираж Ледыни
TeleportList[	101	]	= { "binglang2",		67,		71		}

-- СВ
TeleportList[	102	]	= { "guildwar",			207,	116		}
TeleportList[	103	]	= { "guildwar",			301,	93		}
TeleportList[	104	]	= { "guildwar",			424,	92		}
TeleportList[	105	]	= { "guildwar",			410,	495		}
TeleportList[	106	]	= { "guildwar",			317,	536		}
TeleportList[	107	]	= { "guildwar",			202,	509		}

-- мини СВ
TeleportList[	108	]	= { "guildwar2",		207,	116		}
TeleportList[	109	]	= { "guildwar2",		301,	93		}
TeleportList[	110	]	= { "guildwar2",		424,	92		}
TeleportList[	111	]	= { "guildwar2",		410,	495		}
TeleportList[	112	]	= { "guildwar2",		317,	536		}
TeleportList[	113	]	= { "guildwar2",		202,	509		}

-- Церкоь
TeleportList[	114	]	= { "yschurch",			200,	160		}

-- Новогодняя Деревня
TeleportList[	115	]	= { "07xmas",			144,	136		}
TeleportList[	116	]	= { "07xmas",			144,	243		}

-- Снежная война
TeleportList[	117	]	= { "07xmas2",			144,	136		}
TeleportList[	118	]	= { "07xmas2",			144,	243		}
TeleportList[	119	]	= { "07xmas2",			251,	40		}
TeleportList[	120	]	= { "07xmas2",			266,	88		}
TeleportList[	121	]	= { "07xmas2",			27,		55		}
TeleportList[	122	]	= { "07xmas2",			200,	50		}
TeleportList[	123	]	= { "07xmas2",			220,	220		}
TeleportList[	124	]	= { "07xmas2",			165,	253		}
TeleportList[	125	]	= { "07xmas2",			33,		220		}
TeleportList[	126	]	= { "07xmas2",			66,		201		}
TeleportList[	127	]	= { "07xmas2",			34,		99		}

---------------------------------------------------------------
--                  Защита GM-команд(Начало)                 --
---------------------------------------------------------------
GMPlayers						= {}	-- Массив с именами GM персонажей
--GMPlayers["Administrator"]	= 1		-- Раскомментируйте и введите имя своего GM персонажа
--GMPlayers["Ami"]				= 1		-- Раскомментируйте и введите имя своего GM персонажа
--GMPlayers["test"]				= 1		-- Раскомментируйте и введите имя своего GM персонажа

ProhGMCommand			= {}	-- Запрещенные GM команды на сервере
ProhGMCommand[	1	]	= "&lua"
ProhGMCommand[	2	]	= "&lua_all"
ProhGMCommand[	3	]	= "&reload"

---------------------------------------------------------------
--                   Защита GM-команд(Конец)                 --
---------------------------------------------------------------
...
A_B_C					= 8				-- Неизвестно
Money_all				= 2000000000	-- Переменная количества золота выдаваемое в Хаосе
...
---------------------------------------------------------------
--         Переменные для НПС Джекпот/Лохотрон(Начало)       --
---------------------------------------------------------------
NOWTIME_TE	= 0
NOWTIME_YI	= 0
NOWTIME_HEI	= 0
---------------------------------------------------------------
--         Переменные для НПС Джекпот/Лохотрон(Конец)       --
---------------------------------------------------------------

JINISI_TIME	= 2100 -- Используется для квеста "Бытие" (Переменная времени)
...
--------------------------------
StoneAttrType_Num	= 16 -- Кол-во самоцветов
StoneAttrType		= {}
StoneAttrType[0]	= 0
StoneAttrType[1]	= ITEMATTR_VAL_MNATK	-- Огненный Самоцвет (ID 878)
StoneAttrType[2]	= ITEMATTR_VAL_MNATK	-- Самоцвет Ярости (ID 879)
StoneAttrType[3]	= ITEMATTR_VAL_MNATK	-- Взрывной Самоцвет (ID 880)
StoneAttrType[4]	= ITEMATTR_VAL_HIT		-- Люстриновый Самоцвет (ID 881)
StoneAttrType[5]	= ITEMATTR_VAL_DEF		-- Сияющий Самоцвет (ID 882)
StoneAttrType[6]	= ITEMATTR_VAL_MXHP		-- Блестящий Самоцвет (ID 883)
StoneAttrType[7]	= ITEMATTR_VAL_FLEE		-- Теневой Самоцвет (ID 884)
StoneAttrType[8]	= ITEMATTR_VAL_STA		-- Самоцвет Духа (ID 887)
StoneAttrType[9]	= ITEMATTR_VAL_AGI		-- Самоцвет Ветра (ID 860)
StoneAttrType[10]	= ITEMATTR_VAL_DEX		-- Самоцвет Удара (ID 861)
StoneAttrType[11]	= ITEMATTR_VAL_CON		-- Самоцвет Колосса (ID 862)
StoneAttrType[12]	= ITEMATTR_VAL_STR		-- Самоцвет Ярости (ID 863)
StoneAttrType[13]	= ITEMATTR_VAL_MNATK	-- Глаз Чёрного Дракона (ID 864)
StoneAttrType[14]	= ITEMATTR_VAL_PDEF		-- Душа Чёрного Дракона (ID 865)
StoneAttrType[15]	= ITEMATTR_VAL_MXHP		-- Сердце Чёрного Дракона (ID 866)
StoneAttrType[16]	= ITEMATTR_VAL_STA		-- Самоцвет Души (ID 1012)
...
--------------------------------------------------
LHJ_ID_Num		= 252 -- Кол-во предметов
LHJ_ID			= {}
LHJ_ID[	1	]	= 387
LHJ_ID[	2	]	= 395
LHJ_ID[	3	]	= 397
...
SE	= 15
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--                                                    Массивы для предмета Пагона Реинкарнации (ID 0240) (Конец)                                                      --
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------
StoneEff_Num	= 16 -- Кол-во самоцветов
StoneEff		= {}
StoneEff[0]		= 0
StoneEff[1]		= 4		-- Огненный Самоцвет (ID 878)
StoneEff[2]		= 6		-- Самоцвет Ярости (ID 879)
StoneEff[3]		= 10	-- Взрывной Самоцвет (ID 880)
StoneEff[4]		= 5		-- Люстриновый Самоцвет (ID 881)
StoneEff[5]		= 5		-- Сияющий Самоцвет (ID 882)
StoneEff[6]		= 100	-- Блестящий Самоцвет (ID 883)
StoneEff[7]		= 2		-- Теневой Самоцвет (ID 884)
StoneEff[8]		= 1		-- Самоцвет Духа (ID 887)
StoneEff[9]		= 5		-- Самоцвет Ветра (ID 860)
StoneEff[10]	= 5		-- Самоцвет Удара (ID 861)
StoneEff[11]	= 5		-- Самоцвет Колосса (ID 862)
StoneEff[12]	= 5		-- Самоцвет Ярости (ID 863)
StoneEff[13]	= 50	-- Глаз Чёрного Дракона (ID 864)
StoneEff[14]	= 3		-- Душа Чёрного Дракона (ID 865)
StoneEff[15]	= 500	-- Сердце Чёрного Дракона (ID 866)
StoneEff[16]	= 5		-- Самоцвет Души (ID 1012)

-------------------------------------------
-- Массив с ID самоцветов в ItemInfo.txt --
-------------------------------------------
StoneTpye_ID_Num = 16 -- Кол-во самоцветов
StoneTpye_ID = {}
StoneTpye_ID[0]		= 0
...
StoneTpye_ID[13]	= 0864	-- Глаз Чёрного Дракона
StoneTpye_ID[14]	= 0865	-- Душа Чёрного Дракона
StoneTpye_ID[15]	= 0866	-- Сердце Чёрного Дракона
...
StoneEffType = {}
StoneEffType[0]		= 0
StoneEffType[1]		= 1	-- Огненный Самоцвет (ID 878)
StoneEffType[2]		= 1	-- Самоцвет Ярости (ID 879)
StoneEffType[3]		= 1	-- Взрывной Самоцвет (ID 880)
StoneEffType[4]		= 1	-- Люстриновый Самоцвет (ID 881)
StoneEffType[5]		= 2	-- Сияющий Самоцвет (ID 882)
StoneEffType[6]		= 2	-- Блестящий Самоцвет (ID 883)
StoneEffType[7]		= 2	-- Теневой Самоцвет (ID 884)
StoneEffType[8]		= 4	-- Самоцвет Духа (ID 887)
StoneEffType[9]		= 4	-- Самоцвет Ветра (ID 860)
StoneEffType[10]	= 4	-- Самоцвет Удара (ID 861)
StoneEffType[11]	= 4	-- Самоцвет Колосса (ID 862)
StoneEffType[12]	= 4	-- Самоцвет Ярости (ID 863)
StoneEffType[13]	= 1	-- Глаз Чёрного Дракона (ID 864)
StoneEffType[14]	= 2	-- Душа Чёрного Дракона (ID 865)
StoneEffType[15]	= 2	-- Сердце Чёрного Дракона (ID 866)
StoneEffType[16]	= 4	-- Самоцвет Души (ID 1012)
...
StoneItemType ={}
StoneItemType[0]	= { 0 }
StoneItemType[1]	= { 1,0 }				-- Огненный Самоцвет (ID 878)
StoneItemType[2]	= { 2,3,7,9,0  }		-- Самоцвет Ярости (ID 879)
StoneItemType[3]	= { 4,0 }				-- Взрывной Самоцвет (ID 880)
StoneItemType[4]	= { 1,2,3,4,7,9,23,0 }	-- Люстриновый Самоцвет (ID 881)
StoneItemType[5]	= { 11,22,27,0 }		-- Сияющий Самоцвет (ID 882)
StoneItemType[6]	= { 11,22,27,0 }		-- Блестящий Самоцвет (ID 883)
StoneItemType[7]	= { 1,2,3,4,7,9,24,0 }	-- Теневой Самоцвет (ID 884)
StoneItemType[8]	= { 1,2,3,4,7,9,24,0 }	-- Самоцвет Духа (ID 887)
StoneItemType[9]	= { 24,0 }				-- Самоцвет Ветра (ID 860)
StoneItemType[10]	= { 23,0 }				-- Самоцвет Удара (ID 861)
StoneItemType[11]	= { 11,22,27,0 }		-- Самоцвет Колосса (ID 862)
StoneItemType[12]	= { 1,2,3,4,7,9,0 }		-- Самоцвет Ярости (ID 863)
StoneItemType[13]	= { 1,2,3,4,7,9,0 }		-- Глаз Чёрного Дракона (ID 864)
StoneItemType[14]	= { 11,22,27,0 }		-- Душа Чёрного Дракона (ID 865)
StoneItemType[15]	= { 23,24,0 }			-- Сердце Чёрного Дракона (ID 866)
StoneItemType[16]	= { 1,2,3,4,7,9,0 }		-- Самоцвет Души (ID 1012)
...
GUILDWARCLOSETIME2	= 10800
	...
	--------------------------------------------------------------------------------
	-- Массив с удаляемыми предметами при телепортации на карту "Священная Война" --
	--------------------------------------------------------------------------------
...
Guild1_item[1]	= 1780		Guild1_count[1]	= 1		-- Первый столбец: Камень клятвы (ID 1780) Второй столбец: Кол-во предметов
...
Guild2_item[1]	= 1780		Guild2_count[1]	= 1		-- Первый столбец: Камень клятвы (ID 1780) Второй столбец: Кол-во предметов
...
ITEM_RELIFE			= 3143 -- Оживляющий клевер
...
--------------------------------------------------------
--     Массив предметов из Обычного Сундука (ID 1852) --
--------------------------------------------------------
--                   Структура:                       --
--  1 - ID пердмета; 2 - Шанс выпадения; 3 - Кол-во;  --
--------------------------------------------------------
...
--------------------------------------------------------
--     Массив предметов из НП(Новый Пергамент ID 684) --
--------------------------------------------------------
--                   Структура:                       --
--  1 - ID пердмета; 2 - Шанс выпадения; 3 - Кол-во;  --
--------------------------------------------------------
...
SkillList		= {}
SkillList[1]	= 0280	-- Тело феи
SkillList[2]	= 0311	-- Самоуничтожение
SkillList[3]	= 0312	-- Навык - Вонючка
SkillList[4]	= 0313	-- Навык - Белье
SkillList[5]	= 0314	-- Навык - Лифчик
SkillList[6]	= 0315	-- Навык - Монетный дождь
SkillList[7]	= 0316	-- Навык - Дурак
SkillList[8]	= 0317	-- Навык - Сноб
SkillList[9]	= 0318	-- Навык - Трюкач
SkillList[10]	= 0319	-- Навык - Тупица
SkillList[11]	= 0321	-- Кулинария
SkillList[12]	= 0322	-- Производство
SkillList[13]	= 0323	-- Ремесло
SkillList[14]	= 0324	-- Анализировать
SkillList[15]	= 0338	-- Производство
SkillList[16]	= 0339	-- Кулинария
SkillList[17]	= 0340	-- Ремесло
SkillList[18]	= 0341	-- Анализировать
SkillList[19]	= 0453	-- Духовный удар
SkillList[20]	= 0454	-- Сверхсознание
SkillList[21]	= 0455	-- Удар легиона
SkillList[22]	= 0456	-- Пушка грома
SkillList[23]	= 0457	-- Дьявольское проклятие
SkillList[24]	= 0458	-- Священный суд
SkillList[25]	= 0459	-- Мистическая Сила Перерождения
SkillList[26]	= 0467	-- Узы любви