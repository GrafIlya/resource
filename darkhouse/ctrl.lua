...
function init_entry(map)
    ...
    SetMapEntryMapName(map, "garner") --ÉèÖÃÈë¿ÚµÄÎ»ÖÃ£¨µØÍ¼Ãû£©
     SetMapEntryTime(map, "2010/8/1/0/0", "0/1/0", "0/0/30", "0/0/55") --ÉèÖÃÈë¿ÚµÄÊ±¼ä£¬µØÍ¼¶ÔÏó£¬Ê×´Î¿ªÆôÊ±¼ä£¨Äê/ÔÂ/ÈÕ/Ê±/·Ö£©£¬ÒÔºóÔÙ´Î¿ªÆôµÄ¼ä¸ô£¨ÈÕ/Ê±/·Ö£¬È«£°±íÊ¾Ö»ÓĞÊ×´Î¿ªÆô£©£¬Ã¿´Î¿ªÆôµ½Èë¿ÚÏûÊ§µÄ¼ä¸ô£¨ÈÕ/Ê±/·Ö£¬È«£°±íÊ¾ÓÀ²»ÏûÊ§£©£¬Ã¿´Î¿ªÆôµ½µØÍ¼¹Ø±ÕµÄ¼ä¸ô£¨ÈÕ/Ê±/·Ö£¬È«£°±íÊ¾ÓÀ²»¹Ø±Õ£©¡£¡£
...
function map_copy_run_special_garner2( map_copy ) 
	...
	Notice("Â Ñåğåáğÿííîì õàîñå "..HowManyNoDead.." âûæèâøèõ")
...
--	SystemNotice(role,How_Many_Active)
	...
	if How_Many_Active == 1 then
		...
		local message = "Ïîçäğàâëÿåì "..cha_name.."! Âû âûèãğàëè  ".. Money_Garner2 .." çîëîòà è 1 İìáëåìó  "
	--	SystemNotice(role,How_Many_Active)
