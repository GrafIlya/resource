...
function HistoryMission001()
	...
	MisHelpTalk("<t>Мне надо 3 <yКашемира>, 3 <yСвиной Хвост> и 3 <yТяжелых панциря>. Ты разыскал все?")
	...
	MisNeed(MIS_NEED_DESP, "Найди Меррикса по координатам (1118, 3611)")
	...
	MisHelpTalk("<t>Хорошее вино! Хорошее вино!")
	MisResultCondition(AlwaysFailure )
	...
	MisHelpTalk("<t>Уйди! Оставь меня на едине с вином.")
	MisResultCondition(AlwaysFailure )
	...
	MisHelpTalk("<t>Ступай! Я представляю какое у него будет лицо!")
	MisResultCondition(AlwaysFailure )
	...
	MisBeginAction(AddTrigger, 2501, TE_GETITEM, 4083, 1 )
	...
	MisBeginAction(AddTrigger, 2531, TE_GETITEM, 4084, 1 )		
  ...
  DefineMission(566," Требования оплаты ",392, COMPLETE_SHOW )
   ...
   TriggerAction( 1, AddNextFlag, 393, 10, 5 )
	...
	MisBeginTalk( "<t>Это все так странно!Да...мне кажется что вам надо убить 1 Мудрого Лиса и все закончится." )
	...
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	 MisNeed(MIS_NEED_DESP, "Убейте 1 Циклоническую Медузу в Магическом океане.")
	...
	MisHelpTalk("<t>Портной Мойа в Шайтане (894, 3602) поможет вам ")
	...
	MisHelpTalk("<t>Кость найти достаточно сложно.....")
	...
	MisHelpTalk("<t>Говорят в шлем Кицуне украшает Черная жемчужина.")
	...
	MisBeginTalk( "<t>Ооо мне нужно больше кальция!Достаньте 1 Спин. плавник аметист. дельфина " )
	...
	MisHelpTalk("<t>Купите клевер у целителей.")
	...
	MisBeginTalk( "<t>Вы здесь, чтобы узнать о вашем прошлом?Извените..но я немогу вам помочь.Хотя если вы достанете мне Использованную свечу..." )
	...
	MisBeginTalk( "<t>Ивини , но весь запас зелья кончился.Да и я был очень занят что бы сварить новую порцию... Если вы не можете принести мне:Темная кровь выползня - 1 шт,Чай Бодрячок - 3 шт,Стимулятор - 3 шт.")
	...
	MisBeginTalk( "<t>Вы хотите вспомнить свое прошлое?Ну чтож я помагу вам....Найдите Лангу в Шайтане и расспросите ее о Серном веществе.." )
	...
	MisHelpTalk("<t>Говорят что мумии обитают в дебрях Громоградских лесов (360, 1340).")
	...
	MisHelpTalk("<t>Кентаро в Аскароне ")
	MisResultCondition(AlwaysFailure)
	...
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	MisBeginBagNeed(1)
	MisNeed(MIS_NEED_DESP, "Сходите к Генералу Вильяму ")
	MisHelpTalk("<t>....")
	MisResultCondition(AlwaysFailure)
	...
	MisResultAction(AddExpAndType,2,60000,60000)
     ...
     MisResultCondition(NoRecord, 993)
     ...
     MisHelpTalk("<t>Не беспокойте меня!")
      MisResultTalk("<t>Составить табличку очень сложно.")
     MisResultCondition(NoRecord, 994)
     ...
     MisHelpTalk("<t>Не беспокойте меня!.")
      MisResultTalk("<t>Составить табличку очень сложно.")
     MisResultCondition(NoRecord, 995)
     ...
     MisHelpTalk("<t>Не беспокойте меня!")
      MisResultTalk("<t>Составить табличку очень сложно.")
     MisResultCondition(NoRecord, 997)
	...
	MisHelpTalk("<t>Поговорите с Лангой (853, 3549)")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5076, " Кто же этот Просветленный? ", 1500,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	DefineMission( 5077, " Кто же этот Просветленный? ", 1501,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Поговорите с Лангой ")
	...
	MisResultAction(SetRecord, 1504 )
	DefineMission( 5078, " Кто же этот Просветленный? ", 1502,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Поговорите с Лангой ")
	...
	MisResultAction(SetRecord, 1504 )
	DefineMission( 5079, " Кто же этот Просветленный? ", 1503,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Поговорите с Лангой ")
	...
	MisResultAction(SetRecord, 1504 )
	DefineMission( 5080, " Кто же этот Просветленный? ", 1500,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	DefineMission( 5081, " Кто же этот Просветленный? ", 1501,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы ищите просветленного?Только умные люди могут узнать о нем.")
	MisResultCondition(NoRecord, 1501)
	MisResultCondition(HasMission,1501)
	...
	MisResultAction(SetRecord, 1501 )
	MisResultAction(SetRecord, 1505 )
	DefineMission( 5082, " Кто же этот Просветленный? ", 1502,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы ищите просветленного?Только умные люди могут узнать о нем.")
	MisResultCondition(NoRecord, 1502)
	MisResultCondition(HasMission,1502)
	...
	MisResultAction(SetRecord, 1502 )
	MisResultAction(SetRecord, 1505 )
	DefineMission( 5083, " Кто же этот Просветленный? ", 1503,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы ищите просветленного?Только умные люди могут узнать о нем.")
	MisResultCondition(NoRecord, 1503)
	MisResultCondition(HasMission,1503)
	...
	MisResultAction(SetRecord, 1503 )
	MisResultAction(SetRecord, 1505 )
	DefineMission( 5084, " Кто же этот Просветленный? ", 1500,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	DefineMission( 5085, " Кто же этот Просветленный? ", 1501,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Друг мой...вы достаточно умны...?!")
	MisResultCondition(NoRecord, 1501)
	MisResultCondition(HasMission,1501)
	...
	MisResultAction(SetRecord, 1501 )
	MisResultAction(SetRecord, 1506 )
	DefineMission( 5086, " Кто же этот Просветленный? ", 1502,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Друг мой...вы достаточно умны...?!")
	MisResultCondition(NoRecord, 1502)
	MisResultCondition(HasMission,1502)
	...
	MisResultAction(SetRecord, 1502 )
	MisResultAction(SetRecord, 1506 )
	DefineMission( 5087, " Кто же этот Просветленный? ", 1503,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Друг мой...вы достаточно умны...?!")
	MisResultCondition(NoRecord, 1503)
	MisResultCondition(HasMission,1503)
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5089, " Ученик ", 1507,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	DefineMission( 5090, " Ученик ", 1507,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Председатель Рони говорит что вы не слишком хорошо знакомы со своим классом?")
	MisResultCondition(NoRecord, 1507)
	MisResultCondition(HasMission,1507)
	...
	DefineMission( 5091, " Ученик ", 1507,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	DefineMission( 5092, " Ученик ", 1507,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5110, " Ученик ", 1528,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisHelpTalk("<t>Рони находиться в Аргенте (2242, 2748)")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5112, " Ученик ", 1529,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Отлично!Вы очень быстро справились во всеми заданиями.")
	...
	MisHelpTalk("<t>Рони находиться в Аргенте (2242, 2748) ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5114, " Ученик ", 1530,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Отлично!Вы очень быстро справились во всеми заданиями.")
	...
	MisHelpTalk("<t>Рони находиться в Аргенте (2242, 2748) ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5116, " Ученик ", 1531,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Отлично!Вы очень быстро справились во всеми заданиями.")
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5118, " Оракул Величия ", 1532,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Я слуга Божества воды." )
	...
	MisBeginAction(AddTrigger,  15331, TE_KILL, 642, 1 )
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5121, " Первые врата ", 1534,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Я слуга Божества огня " )
	...
	MisHelpTalk("<t>Желаю вам удачи!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5124, " Вторые врата ", 1536,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Я слуга Божества ветра." )
	...
	MisBeginAction(AddTrigger,  15371, TE_KILL, 587, 3 )
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisHelpTalk("<t>Желаю вам удачи!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5127, " Третьи врата ", 1538,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы до сих пор в нормальном состояни?")
	...
	MisBeginTalk( "<t>Я слуга Божества земли " )
	...
	MisBeginAction(AddTrigger,  15391, TE_KILL, 570, 4 )
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisHelpTalk("<t>Желаю вам удачи!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5130, " Четвертые врата ", 1540,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы до сих пор в нормальном состояни?")
	...
	MisBeginTalk( "<t>Я слуга Божества снега " )
	...
	MisHelpTalk("<t>Желаю вам удачи!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5133, " Пятые врата ", 1542,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы до сих пор в нормальном состояни?")
	...
	MisBeginTalk( "<t><Я слуга Божества грома " )
	...
	MisHelpTalk("<t>Желаю вам удачи!!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5136, " Шестые врата ", 1544,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы до сих пор в нормальном состояни?")
	...
	MisBeginTalk( "<t>Я слуга Божества молний " )
	...
	MisHelpTalk("<t>Желаю вам удачи!")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5139, " Седьмые врата ", 1546,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Вы до сих пор в нормальном состояни? ")
	...
	MisBeginTalk( "<t>Я слуга Божества любви " )
	...
	MisHelpTalk("<t>Богиня с Вами ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5142, " Инструкция к последним вратам ", 1548,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>В доказательство того что вы идеальный пират , пройдите несколько заданий " )
	...
	MisBeginTalk( "<t>Ваше второе задание.Достать для меня 2 Королевских меча " )
	...
	MisBeginTalk( "<t>Ооо Сирены напали на мой корабль!Отомсти им!" )
	...
	MisBeginTalk( "<t>Недавно я гулял по пляжу , и увидел красивые кристалы.Я украл их...Знаете мне так неловко.Но думаю если мы уничтожим свидетелей..." )
	...
	MisHelpTalk("<t>Будте осторожнее ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5148, " Тайна разгадана ", 1553,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisHelpTalk("<t>Будте осторожнее ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5150, " Тайна разгадана ", 1554,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Не беспокойте меня!")
	...
	MisHelpTalk("<t>Будте осторожнее ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5152, " Тайна разгадана ", 1555,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Не беспокойте меня!")
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5153, " Стариковский спор ", 1557,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Вы достаточно умен.Ответе еще на один вопрос!" )
	...
	DefineMission( 5155, " Лечение ", 1566 )
	MisBeginTalk( "<t>Ха-ха.Мне нужна граната!" )
	...
	RegCurTrigger( 15661 )
	DefineMission( 5156, "Лечение ", 1567 )
	MisBeginTalk( "<t>Мне нужна Световая бомба 3 ур.  " )
	...
	MisResultCondition(AlwaysFailure)
	DefineMission( 5158, " Страж правды ", 1568,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisHelpTalk("<t>Ну же!Идите ")
	MisResultCondition(AlwaysFailure)
	DefineMission( 5160, " Страж правды ", 1569,COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>You mean Granny Dong has admitted failure? You aren't joking with me, are you? Wahaha looks like the truth is in the hands of wise men like me, though we are far and few. You are hereby appointed Guardian of Truth by the great Weird Grampa!")
	...
	MisBeginAction(AddTrigger, 15701, TE_GETITEM, 2408, 1 )		
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisBeginAction(AddTrigger, 15721, TE_GETITEM, 2409, 1 )		
	MisCancelAction(SystemNotice, "Квест не может быть удален")
	...
	MisBeginAction(AddTrigger, 15731, TE_GETITEM, 2410, 1 )		
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisBeginAction(AddTrigger, 15741, TE_GETITEM, 2411, 1 )		
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
	...
	MisBeginAction(AddTrigger, 15751, TE_GETITEM, 2412, 1 )		
	MisCancelAction(SystemNotice, "Квест не может быть удален ")
