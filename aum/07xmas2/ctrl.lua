...
-- Автор: Larein [MD Piratia Team][WWW.MainDEV.RU]
...
function init_entry(map)
    ...
    SetMapEntryTime(map, "2010/01/01/5/0", "0/4/0", "0/0/30", "0/0/55") 
end
...
function map_copy_before_close_07xmas2( map_copy )
	...
	Every_5_minute = 0				
	Snow_BOSS = 0					-- Обнуляем параметр Snow_BOSS (0 - босс не вызывался, 1 - босс вызывался)
end
